...
- 🎵 **Media & Content**: Audio, visual, and content-focused apps (Days 16, 18, 21, 24, 38)
- 📋 **Task & Data Management**: Organizational and productivity tools (Days 7, 13, 25, 27, 30, 33, 37)
- 🌐 **API & External Data**: Projects that consume external data sources (Days 6, 12, 15, 36)
- 🎨 **Graphics & Design**: Color and design-oriented applications (Days 23, 32)
...
| --- | -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | ----- |
| 01  | [New Year Countdown](#day-01-new-year-countdown)                                 | Stylish countdown app showing time remaining to next New Year with animated display          | 🔰    |
| 02  | [Analog and Digital Clock](#day-02-analog-and-digital-clock)                     | Modern dual-display clock with smooth animations and color-coded hand indicators             | 🔰    |
| 03  | [Snake Game](#day-03-snake-game)                                                 | Classic snake game with score tracking, increasing difficulty, and responsive design         | 🔰    |
| 04  | [Ping Pong Game](#day-04-ping-pong-game)                                         | Two-player arcade-style ping pong with realistic physics and retro sound effects             | 🔰    |
| 05  | [Calculator](#day-05-calculator)                                                 | React-based calculator with responsive UI, keyboard support, and basic operations            | 🔰    |
| 06  | [Weather Application](#day-06-weather-application)                               | React weather app with city search, current location detection, and dynamic icons            | 🔰    |
| 07  | [To Do List](#day-07-to-do-list)                                                 | Clean, efficient task manager built with React for organizing daily activities               | 🔰    |
| 08  | [Tic Tac Toe Game](#day-08-tic-tac-toe-game)                                     | Modern implementation of classic Tic Tac Toe with two-player mode and win detection          | 🔰    |
| 09  | [BMI Calculator](#day-09-bmi-calculator)                                         | Simple Body Mass Index calculator showing health category and weight status                  | 🔰    |
| 10  | [Currency Converter](#day-10-currency-converter)                                 | Real-time currency converter using up-to-date exchange rates for quick conversions           | 🔰    |
| 11  | [BMR Calculator](#day-11-bmr-calculator)                                         | Basal Metabolic Rate calculator providing personalized daily calorie recommendations         | 🔰    |
| 12  | [Superhero Search](#day-12-superhero-search)                                     | Web application for searching and displaying superhero information using an API              | 🔰    |
| 13  | [Expense Tracker](#day-13-expense-tracker)                                       | Financial management tool to track spending, visualize patterns, and manage expense history  | 🔷    |
| 14  | [Typing Speed Test](#day-14-typing-speed-test)                                   | Application that measures typing speed and accuracy with real-time feedback                  | 🔷    |
| 15  | [Face Detector](#day-15-face-detector)                                           | Browser-based face detection tool using modern web APIs to identify faces in images          | 🔷    |
| 16  | [Quote Generator](#day-16-quote-generator)                                       | Random quote generator with author attribution and social sharing options                    | 🔰    |
| 17  | [Password Generator](#day-17-password-generator)                                 | Secure password generator with customizable options and strength indicator                   | 🔰    |
| 18  | [Image Color Picker](#day-18-image-color-picker)                                 | Tool for extracting exact color codes from uploaded images with multi-format support         | 🔰    |
| 19  | [Tetris Game](#day-19-tetris-game)                                               | Classic Tetris game with score tracking, levels, and responsive controls                     | 🔷    |
| 20  | [Tip Calculator](#day-20-tip-calculator)                                         | Calculator for determining tip amounts based on bill total and service quality               | 🔰    |
| 21  | [Image Slider](#day-21-image-slider)                                             | Responsive image carousel with navigation controls and smooth transitions                    | 🔰    |
| 22  | [Rock Paper Scissors Game](#day-22-rock-paper-scissors-game)                     | Modern implementation of the classic game with animated results and statistics               | 🔷    |
| 23  | [Color Palette Generator](#day-23-color-palette-generator)                       | Tool for creating harmonious color combinations with export options and favorites            | 🔷    |
| 24  | [Music Player App](#day-24-music-player-app)                                     | React-powered music player with playlist management and audio visualization                  | 🔷    |
| 25  | [Text Editor](#day-25-text-editor)                                               | Lightweight browser-based editor with formatting options and syntax highlighting             | 🔰    |
| 26  | [2048 Game](#day-26-2048-game)                                                   | React implementation of the popular sliding tile puzzle game with score tracking             | 🔷    |
| 27  | [JSON Reader App](#day-27-json-reader-app)                                       | Tool for parsing and visualizing JSON data with tree view and search capabilities            | 🔰    |
| 28  | [Palindrome Checker](#day-28-palindrome-checker)                                 | Dark-themed app to verify if text reads the same forward and backward                        | 🔰    |
| 29  | [Pyramid Generator](#day-29-pyramid-generator)                                   | Interactive text art generator for creating customizable ASCII pyramids with various options | 🔰    |
| 30  | [Gradebook App](#day-30-gradebook-app)                                           | Educational tool for tracking academic performance with separate student and teacher views   | 🔷    |
| 31  | [Dragon Repeller](#day-31-dragon-repeller)                                       | Text-based fantasy RPG with combat, inventory management, and character progression          | 🔷    |
| 32  | [Background Color Generator](#day-32-background-color-generator)                 | Color tool with palette generation, history tracking, and harmony-based suggestions          | 🔷    |
| 33  | [Calorie Counter](#day-33-calorie-counter)                                       | Nutrition tracker with meal categorization and personalized calorie recommendations          | 🔷    |
| 34  | [Rock, Paper, Scissors, Lizard, Spock](#day-34-rock-paper-scissors-lizard-spock) | Expanded game with five choices based on "The Big Bang Theory" with modern UI                | 🔷    |
| 35  | [Date Formatter](#day-35-date-formatter)                                         | Convert between date formats with real-time clock and copy-to-clipboard function             | 🔷    |
...
![New Year Countdown Screenshot](assets/project-screenshots/01-new-year-countdown.webp)
...
![Analog and Digital Clock Screenshot](assets/project-screenshots/02-analog-and-digital-clock.webp)
...
![Snake Game Screenshot](assets/project-screenshots/03-snake-game.webp)
...
![Ping Pong Game Screenshot](assets/project-screenshots/04-ping-pong-game.webp)
...
![Calculator Screenshot](assets/project-screenshots/05-calculator.webp)
...
![To Do List Screenshot](assets/project-screenshots/07-todo-list.webp)
...
![Tic Tac Toe Game Screenshot](assets/project-screenshots/08-tic-tac-toe-game.webp)
...
![BMI Calculator Screenshot](assets/project-screenshots/09-bmi-calculator.webp)
...
![BMR Calculator Screenshot](assets/project-screenshots/11-bmr-calculator.webp)
...
![Expense Tracker Screenshot](assets/project-screenshots/13-expense-tracker.webp)
...
![Typing Speed Test Screenshot](assets/project-screenshots/14-typing-speed-test.webp)
...
![Password Generator Screenshot](assets/project-screenshots/17-password-generator.webp)
...
![Image Color Picker Screenshot](assets/project-screenshots/18-image-color-picker.webp)
...
![Tetris Game Screenshot](assets/project-screenshots/19-tetris-game.webp)
...
![Tip Calculator Screenshot](assets/project-screenshots/20-tip-calculator.webp)
...
![Image Slider Screenshot](assets/project-screenshots/21-image-slider.webp)
...
![Rock Paper Scissors Game Screenshot](assets/project-screenshots/22-rock-paper-scissors-game.webp)
...
![Color Palette Generator Screenshot](assets/project-screenshots/23-color-palette-generator.webp)
...
![Music Player App Screenshot](assets/project-screenshots/24-music-player-app.webp)
...
![Text Editor Screenshot](assets/project-screenshots/25-text-editor.webp)
...
![2048 Game Screenshot](assets/project-screenshots/26-2048-game.webp)
...
![JSON Reader App Screenshot](assets/project-screenshots/27-json-reader-app.webp)
...
![Palindrome Checker Screenshot](assets/project-screenshots/28-palindrome-checker.webp)
...
![Pyramid Generator Screenshot](assets/project-screenshots/29-pyramid-generator.webp)
...
![Gradebook App Screenshot](assets/project-screenshots/30-gradebook-app.webp)
...
![Dragon Repeller Screenshot](assets/project-screenshots/31-dragon-repeller.webp)
...
![Background Color Generator Screenshot](assets/project-screenshots/32-background-color-generator.webp)
...
![Calorie Counter Screenshot](assets/project-screenshots/33-calorie-counter.webp)
...
![Rock, Paper, Scissors, Lizard, Spock Screenshot](assets/project-screenshots/34-rock-paper-scissors-lizard-spock.webp)
...
![Date Formatter Screenshot](assets/project-screenshots/35-date-formatter.webp)
...
![Advanced Todo App Screenshot](assets/project-screenshots/37-advanced-todo-app.webp)
